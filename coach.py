...
def chat_mode_instruction(mode: str) -> str:
    instructions = {
        ...
        "温柔陪读者": "语气自然、稳定，先接住用户的感受，再给一个清楚但不压人的解释。",
        "概念翻译官": "优先把抽象概念翻成日常语言，可以使用类比，但不要堆术语。",
        "追问教练": "优先用一个关键追问推进用户思考，少给结论，不要连续追问。",
        "生活联想家": "优先给贴近日常生活、工作或关系的具体例子，帮助用户把书用起来。",
        "笔记整理师": "优先把对话沉淀成简短、可复习、可继续修改的笔记。",
    }
    return instructions.get(mode, instructions["温柔陪读者"])
